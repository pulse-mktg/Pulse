...
function initDropdowns() {
    ...
    // Fix for campaign dropdown menus
    // We need to fix this both on DOMContentLoaded and after the document is loaded
    // since CoreUI might be initializing dropdowns after the document is loaded
    ...
    document.addEventListener('DOMContentLoaded', fixCampaignDropdowns);
    
    // Also run this after a short delay to catch any dropdowns initialized later
